...
{
    [TestFixture]
    public class AddHashEntryExistsConditionShould
    {
        ...
        public void SetCorrectConditionOnInternalTransaction()
        {
            ...
            _transaction.AddHashEntryExistsCondition("my-hash", "my-key");

            Assert.AreEqual(1, conditions.Count);
            Util.AssertConditionsAreEqual(Condition.HashExists("my-hash", "my-key"), conditions[0]);
        }
    }
}
