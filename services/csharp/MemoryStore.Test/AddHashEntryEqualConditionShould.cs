...
{
    [TestFixture]
    public class AddHashEntryEqualConditionShould
    {
        ...
        public void SetCorrectConditionOnInternalTransaction()
        {
            ...
            _transaction.AddHashEntryEqualCondition("my-hash", "my-key", "my-value");

            Assert.AreEqual(1, conditions.Count);
            Util.AssertConditionsAreEqual(Condition.HashEqual("my-hash", "my-key", "my-value"), conditions[0]);
        }
    }
}
