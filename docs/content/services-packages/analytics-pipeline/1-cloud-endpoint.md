...
This section covers the creation of an endpoint to send analytics events to, which acts as the start of the analytics pipeline.

<%(TOC)%>

## Initiating, Verifying & Deploying the Analytics Endpoint
